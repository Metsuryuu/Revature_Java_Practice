...
/*
 * DTO stands for Data Transfer Object. It is used to encapsulate data and send it from one subsystem to another.
 * DTO's are commonly used in n-tier architecture to transfer data between a MODEL and VIEW.
...
public class EmployeeDTO implements Serializable{
	...
	//change this property to a String.
