...
public class CharacterWrapperDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Letter and Digit Count : "+alphaNum);
		System.out.println("Total Space Count : "+spaces);
		System.out.println("Total Special Character Count : "+special);
	}
